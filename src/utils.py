...
def deduplicate_and_format_sources(
    ...
    *,
    ...
    selected_sources = list(unique_sources.values())
    ...
    content_char_limit = max(400, char_limit // 2)
    raw_content_char_limit = max(400, char_limit // 2)
    ...
    for source in selected_sources:
        ...
        if len(content) > content_char_limit:
            content = f"{content[:content_char_limit]}... [truncated]"
        ...
        if fetch_full_page:
            ...
            if raw_content is None:
                ...
                raw_content = ""
            if len(raw_content) > raw_content_char_limit:
                raw_content = f"{raw_content[:raw_content_char_limit]}... [truncated]"
