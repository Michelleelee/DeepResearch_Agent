...
def create_app() -> FastAPI:
    ...
    def log_startup_configuration() -> None:
        ...
        logger.info(
            ...
            "max_loops=%s fetch_full_page=%s search_max_results=%s max_tokens_per_source=%s "
            "max_summary_context_chars=%s task_parallelism=%s tool_calling=%s strip_thinking=%s api_key=%s",
            config.llm_provider,
            ...
            config.max_summary_context_chars,
